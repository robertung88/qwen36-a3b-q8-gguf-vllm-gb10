...
def maybe_override_with_speculators(
    ...
    **kwargs,
    ...
    # GB10 recipe patch: Transformers cannot parse some GGUF architectures such as
    # qwen35/qwen35moe. vLLM has its own GGUF loader, so do not inspect GGUF
    # files here for Speculators metadata. Explicit speculative configs still
