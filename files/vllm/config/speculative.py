        ...
        if self.method in ("ngram", "ngram_gpu"):
            ...
            if self.model is not None:
                self.draft_model_config = ModelConfig(
                    ...
                    # GGUF draft/MTP models need the same HF config path as the
                    # target. Otherwise ModelConfig tries to parse the .gguf file
                    # itself via the transformers GGUF reader, which rejects
                    # Qwen3.5/Qwen3.6 architectures such as qwen35moe.
